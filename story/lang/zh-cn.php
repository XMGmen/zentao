 ...
 */
$lang->story->createStory='提Story';
$lang->story->browse      = "需求列表";
 $lang->story->title      = "名称";
$lang->story->create      = "提BackLog";
$lang->story->createCase  = "建用例";
$lang->story->batchCreate = "批量添加";
$lang->story->change      = "Story变更";
$lang->story->backlogchange= "Backlog变更";
...
$lang->story->backlogtitle   = 'Backlog名称';
$lang->story->backlogspec    = 'Backlog描述';

// added by fxq
$lang->story->backlogsource   = '所属BackLog';
$lang->story->storytitle     = 'story名称';
$lang->story->storyspec      = 'story描述';
$lang->story->backlogdesc    = 'Back Log描述';
$lang->story->verify         = '验收标准';
$lang->story->type           = '需求类型 ';
$lang->story->pri            = '优先级';
$lang->story->estimate       = '预计点数';
...
$lang->story->backlogtitle   = 'Back Log名称';
$lang->story->storytitle     = 'Story名称';
...
$lang->story2->stageList['']           = '';
$lang->story2->stageList['wait']       = '未开始';
$lang->story2->stageList['planned']    = '已计划';
$lang->story2->stageList['projected']  = '已立项';
$lang->story2->stageList['developing'] = '研发中';
$lang->story2->stageList['developed']  = '研发完毕';
$lang->story2->stageList['testing']    = '测试中';
$lang->story2->stageList['tested']     = '测试完毕';
$lang->story2->stageList['verified']   = '已验收';
$lang->story2->stageList['released']   = '已发布';
$lang->story2->stageList['canceled']   = '已取消';
...
$lang->Backlog->legendSpec         = 'BackLog';
...
// addedbyheng
$lang->story->sprint        = '所属Sprint';
$lang->story->estimatetime  = '预计点数';
$lang->story->hourtime      = '点数';
$lang->story->exportBacklog = '导出BackLog';
