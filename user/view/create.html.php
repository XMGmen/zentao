  ...
  <form class='form-condensed mw-700px' method='post' target='hiddenwin' id='dataform'>
    <table align='center' class='table table-form'> 
      <tr>
        ...
        <td class='w-p50'><?php echo html::select('dept', $depts, $deptID, "class='form-control'");?></td>
      </tr>
      <tr>
      ...
      <tr>
        <th><?php echo $lang->user->fastMsg;?></th>
        <td><?php echo html::input('fastMsg', '', "class='form-control'");?></td>
      </tr>
      <tr>
