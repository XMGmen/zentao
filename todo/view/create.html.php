  ...
  <form class='form-condensed' method='post' target='hiddenwin' id='dataform'>
    <table class='table table-form'> 
      ...
      <tr>
        ...
        <td style='text-align:left'><input type='checkbox' id='switchDate' onclick='switchDateFeature(this);'> <?php echo $lang->todo->lblDisableDate;?></td>
      </tr>  
      <tr>
        <th><?php echo $lang->todo->private;?></th>
        <td style='text-align:left'><input type='checkbox' name='private' id='private' value='1'></td>
      </tr>  
      <tr>
        <td></td>
