...
class productplan extends control
{
    ...
    public function commonAction($productID)
    {
        ...
        $this->view->position[] = html::a($this->createLink('product', 'productplan', "productID=$productID"), $products[$productID]);
    ...
    public function create($product = '')
    {
        if(!empty($_POST))
        {
            ...
            die(js::locate($this->createLink('product', 'productplan', "productID=$product"), 'parent'));
        }
     ...
     * @return void
     */
    public function edit($planID, $product = '')
    {
        if(!empty($_POST))
        {
