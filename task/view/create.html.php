  ...
  <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
    <table class='table table-form'> 
      ...
      <tr>
        ...
        </td><td style='text-align:left'><div class='help-block'><?php echo $lang->task->estimateTip?></div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan='3' style='text-align:left'><?php echo html::radio('after', $lang->task->afterChoices, 'toTaskList');?></td>
      </tr>
      <tr>
        <td></td>
