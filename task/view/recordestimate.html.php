...
<div id='titlebar'>
  <div class='heading'>
    ...
    <strong><?php echo html::a($this->createLink('task', 'view', 'task=' . $task->id), $task->name);?></strong>
    <!-- changedbyheng -->
    <small class='text-muted'> <?php echo $lang->task->logEffortstime;?> <?php echo html::icon($lang->icons['recordEstimate']);?></small>
  </div>
</div>
<div class='main'>
    ...
    <table class='table table-form'>
      ...
      <thead>
        <tr class='text-center'>
          ...
          <th class="w-60px"><?php echo $lang->task->consumedThisTimePoint;?></th> <!-- changedbyheng -->
      ...
      <?php endforeach;?>
      <?php endif;?>
      <?php if($task->status == 'wait' or $task->status =='pause' or $task->status == 'doing' or $task->status =='doing1' or $task->status=='doing2' or $task->status=='doing3' or $task->status=='doing4'):?>
      <thead>
        <tr class='text-center'>
          <th class="w-id"><?php echo $lang->idAB;?></th>
