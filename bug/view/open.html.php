...
<div id='titlebar'>
  <div class='heading'>
    ...
    <small class='text-danger'> <?php echo $lang->bug->reopen;?></small>
  </div>
</div>
...
<form class='form-condensed' method='post' target='hiddenwin'>
  <table class='table table-form'>
    ...
    <tr>
      <th></th><td><?php echo '&nbsp&nbsp&nbsp'.html::submitButton('',"onclick='return checkData()'") . html::linkButton($lang->goback, $this->session->bugList);?></td>
    </tr>
  </table>
</form>
<div class='main'>
