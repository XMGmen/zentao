...
<form class='form-condensed' method='post' enctype='multipart/form-data' target='hiddenwin'>
  <table class='table table-form'>
    ...
    <tr>
      ...
      <td colspan='2'><div class="required required-wrapper"></div><?php echo html::textarea('comment', '', "rows='6' class='form-control'");?></td>
    </tr>
    <tr>
      <th></th><td colspan='2'><?php echo html::submitButton('保存',"onclick='return checkData()'") . html::linkButton($lang->goback, $this->session->bugList);?></td>
    </tr>
  </table>
</form>
<script>
