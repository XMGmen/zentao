...
<form class='form-condensed' method='post' target='hiddenwin'>
  <table class='table table-form'>
    <tr>
      ...
      <td class='w-p25-f'><?php echo html::select('assignedTo', $users, $bug->assignedTo, "class='form-control'");?></td><td></td>
    </tr>  
    <tr>
    ...
    <tr>
      <th></th><td colspan='2'><?php echo html::submitButton('',"onclick='return checkData()'") . html::linkButton($lang->goback, $this->server->http_referer);?></td>
    </tr>
  </table>
</form>
<div class='main'>
