 ...
 */
$lang->look           ='点击查看';
$lang->taskcreate     ='分解任务';
$lang->taskbatchCreate='批量添加任务';
$lang->bugedit        ='编辑';
$lang->backlogchange  ='变更backlog';
$lang->backlogedit    ='编辑backlog';
$lang->storyedit      ='编辑story';
$lang->changestory    ='变更story';
$lang->taskedit       ='编辑task';
$lang->backlogreview  ='backlog评审';
$lang->storyreview    ='story评审';
...
$lang->zentaoPMS      = '禅道';
$lang->welcome        = "禅道";
//$lang->welcome        = "%s项目管理系统";//changedbyheng
$lang->myControl      = "我的地盘";
...
$lang->year         = '年';
$lang->workingHour  = '工时';
$lang->workingHourtime  = '点数'; // addedbyheng
...
$lang->my->menu->bug            = array('link' => '我的Bug|my|bug|',   'subModule' => 'bug');
$lang->my->menu->todo           = array('link' => '我的待办|my|todo|', 'subModule' => 'todo');
$lang->my->menu->task           = array('link' => '我的任务|my|task|', 'subModule' => 'task');
$lang->my->menu->story          = array('link' => '我的需求|my|story|',   'subModule' => 'story');
$lang->my->menu->myProject      = "我的{$lang->projectCommon}|my|project|";
...
$lang->product->menu->story   = array('link' => '需求|product|browse|productID=', 'alias' => 'batchedit', 'subModule' => 'story');
$lang->product->menu->dynamic = '动态|product|dynamic|productID=';
$lang->product->menu->plan    = array('link' => '计划|productplan|browse|productID=', 'subModule' => 'productplan');
$lang->product->menu->release = array('link' => '发布|release|browse|productID=',     'subModule' => 'release');
$lang->product->menu->roadmap = '路线图|product|roadmap|productID=';
$lang->product->menu->doc     = array('link' => '文档|product|doc|productID=', 'subModule' => 'doc');
$lang->product->menu->module  = '模块|tree|browse|productID=%s&view=story';
$lang->product->menu->view    = array('link' => '概况|product|view|productID=', 'alias' => 'edit');
$lang->product->menu->project = "{$lang->projectCommon}|product|project|status=all&productID=";
$lang->product->menu->create  = array('link' => "<i class='icon-plus'></i>&nbsp;添加{$lang->productCommon}|product|create", 'float' => 'right');
$lang->product->menu->all     = array('link' => "<i class='icon-cubes'></i>&nbsp;所有{$lang->productCommon}|product|index|locate=no&productID=", 'float' => 'right');
...
$lang->project->menu->task      = array('link' => '任务|project|task|projectID=', 'subModule' => 'task,tree', 'alias' => 'grouptask,importtask,burn,importbug');
$lang->project->menu->story     = array('link' => '需求|project|story|projectID=', 'subModule' => 'story', 'alias' => 'linkstory');
$lang->project->menu->bug       = 'Bug|project|bug|projectID=';
$lang->project->menu->dynamic   = '动态|project|dynamic|projectID=';
$lang->project->menu->build     = array('link' => '版本|project|build|projectID=', 'subModule' => 'build');
$lang->project->menu->testtask  = '测试|project|testtask|projectID=';
$lang->project->menu->team      = array('link' => '团队|project|team|projectID=', 'alias' => 'managemembers');
$lang->project->menu->doc       = array('link' => '文档|project|doc|porjectID=', 'subModule' => 'doc');
$lang->project->menu->product   = $lang->productCommon . '|project|manageproducts|projectID=';
$lang->project->menu->view      = array('link' => '概况|project|view|projectID=', 'alias' => 'edit,start,suspend,putoff,close');
$lang->project->menu->create    = array('link' => "<i class='icon-plus'></i>&nbsp;添加{$lang->projectCommon}|project|create", 'float' => 'right');
$lang->project->menu->all       = array('link' => "<i class='icon-th-large'></i>&nbsp;所有{$lang->projectCommon}|project|index|locate=no&status=undone&projectID=", 'float' => 'right');
...
$lang->bug->menu->bug      = array('link' => 'Bug|bug|browse|productID=', 'alias' => 'view,create,batchcreate,edit,resolve,close,activate,report,batchedit,confirmbug,assignto', 'subModule' => 'tree');
$lang->bug->menu->testcase = array('link' => '用例|testcase|browse|productID=');
$lang->bug->menu->testtask = array('link' => '版本|testtask|browse|productID=');

$lang->testcase = new stdclass();
$lang->testcase->menu = new stdclass();

/* $lang->testcase->menu->product  = '%s'; */
$lang->testcase->menu->bug      = array('link' => 'Bug|bug|browse|productID=');
$lang->testcase->menu->testcase = array('link' => '用例|testcase|browse|productID=', 'alias' => 'view,create,batchcreate,edit,batchedit,showimport,groupcase', 'subModule' => 'tree');
$lang->testcase->menu->testtask = array('link' => '版本|testtask|browse|productID=', 'alias' => 'view,create,edit,linkcase,cases,start,close,batchrun,groupcase');
...
$lang->doc->menu->browse  = array('link' => '文档|doc|browse|libID=', 'alias' => 'view,create,edit');
$lang->doc->menu->edit    = '编辑|doc|editLib|libID=';
$lang->doc->menu->module  = '分类|tree|browse|libID=&viewType=doc';
$lang->doc->menu->delete  = array('link' => '删除|doc|deleteLib|libID=', 'target' => 'hiddenwin');
...
$lang->company->menu->batchAddUser = array('link' => '<i class="icon-plus-sign"></i>&nbsp;批量添加|user|batchCreate|dept=', 'subModule' => 'user', 'float' => 'right');
$lang->company->menu->addUser      = array('link' => '<i class="icon-plus"></i>&nbsp;添加用户|user|create|dept=', 'subModule' => 'user', 'float' => 'right');
...
$lang->icons['storychange']    = 'random';
// $lang->menu->pro      = $lang->productCommon . '|pro|index';
// $lang->menu->mytest   = $lang->productCommon . '|mytest|index';
// $lang->menu->sprint   = $lang->productCommon . '|sprint|index';

$lang->menu->pro      = 'Plan|pro|index';//++
$lang->menu->sprint   = 'Sprint|sprint|index';
$lang->menu->myImage  = 'myImage|myImage|index';
$lang->menu->mySprintBoard  = 'mySprintBoard|mySprintBoard|index';
$lang->menu->importbugs  = 'Import|importbugs|index';

$lang->sprintcommon   = 'sprint';//++
$lang->sprintedit     = '编辑sprint';
$lang->giveScore      = '我要投票';
