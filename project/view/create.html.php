  ...
  <form class='form-condensed' method='post' target='hiddenwin' id='dataform'>
    <table class='table table-form'> 
      ...
      <tr>
       ...
       <tr>
        <th><?php echo $lang->project->managePlans;?></th>
        <td class='text-left' id='plansBox' colspan="2"><?php echo html::select("plans[]", $allPlans, $products, "class='form-control chosen' data-placeholder='{$lang->project->linkPlan}' multiple");?></td>
      </tr>
