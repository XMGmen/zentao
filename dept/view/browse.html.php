...
<div id='featurebar'><!-- tag name fixed by xufangye -->
  <div class='heading'><?php echo html::icon($lang->icons['dept']);?> <?php echo $lang->dept->common;?></div>
</div>
<div class='main'>
  <div class='row'>
    <div class='col-sm-6'>
      <div class='panel panel-sm' style="width: 350px">
    ...
    <div class='col-sm-6'>
      <div class='panel panel-sm' style="width: 400px">
        <div class='panel-heading'>
