...
<div id="procreatesprint">
	<ul id="myTab" class="nav nav-tabs">
		...
		<?php echo html::a($this->createLink('sprint', 'index', "projectID=$story->project"),"User Story");?>
		</li>
		<li id="sprintviewid">
		<?php echo html::a($this->createLink('sprint', 'task', "projectID=$story->project"),"任务");?>
		</li>
		<li id="sprintviewid">
		<?php echo html::a($this->createLink('sprint', 'bug', "projectID=$story->project"),"Bug");?>
		</li>
		<li id="sprintviewid">
		<?php echo html::a($this->createLink('sprint', 'review', "projectID=$story->project"),"回顾会");?>
		</li>
		<li id="sprintviewid">
		<?php echo html::a($this->createLink('sprint', 'burn', "projectID=$story->project"),"燃尽图");?>
		</li>
		<li id="sprintviewid">
		<?php echo html::a($this->createLink('sprint', 'team', "projectID=$story->project"),"团队");?>
		</li>
	</ul>
</div>
...
<div class='container mw-1400px'>
  <div id='titlebar' style='margin-top:0px'>
    <div class='heading'>
      ...
      <strong><?php echo html::a($this->createLink('sprint', 'storyview', "storyID=$story->id&version=$story->version&from=project&param=$story->project"), $story->title);?></strong>
  ...
  <form method='post' target='hiddenwin' class='form-condensed'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td colspan='2'><?php echo html::select('reviewedBy[]', $users, $app->user->account, "class='form-control' ");?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <?php echo html::linkButton($lang->goback, helper::createLink('sprint', 'index', "projectID=$story->project"));?>
          </td>
        </tr>
      </table>
  </form>
