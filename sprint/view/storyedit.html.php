  ...
  <div class='col-main'>
    <div class='main'>
      ...
      <div class='actions actions-form' style='text-align:center'>
        ...
        echo html::linkButton($lang->goback, helper::createLink('sprint', 'index', "projectID=$story->project"));
        ?>
      </div>
    ...
    <div class='main main-side'>
      <fieldset>
        ...
        <table class='table table-form'>
          <tr>
            <th class='w-80px'><?php echo $lang->sprint->product;?></th>
          ...
          <tr>
			...
			<tr>
            <th><?php echo $lang->sprint->fromsprint;?></th> <!-- changedbyheng -->
          ...
          <tr>
            ...
            <td><?php echo html::select('stage', $lang->story2->stageList, $story->stage, 'class=form-control');?></td>
          </tr>
          <?php endif;?>
          <tr>
          ...
          <tr>
            <th><?php echo $lang->story->estimate;?></th> <!-- changedbyheng -->
