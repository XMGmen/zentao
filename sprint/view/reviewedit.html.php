...
<div class='container mw-1400px'>
  ...
  <div id='titlebar' style='background-color:#F7F7F7'>
	  <div class='heading'>
...
<div id='titlebar' style='background-color:#F7F7F7'>
    ...
    <table class='table table-form'> 
      ...
      <tr>
        ...
        <td>
          <div class='input-group'>
            <?php echo html::input('real_begin',$real_begin, "class='form-control w-100px form-date' onchange='computeWorkDays()' placeholder='" . $lang->project->begin . "'");?>
            <span class='input-group-addon' style='background-color:#F7F7F7'><?php echo $lang->project->to;?></span>
            <?php echo html::input('real_end', $real_end, "class='form-control form-date' onchange='computeWorkDays()' placeholder='" . $lang->project->end . "'");?>
          </div>
        </td>
        <td style='visibility:hidden'>
          &nbsp; &nbsp; <?php echo html::radio('delta', $lang->project->endList , '', "onclick='computeEndDate(this.value)'");?>
      ...
      <tr>
        ...
        <td colspan='2'><?php echo html::textarea('sprintDesc', $sprintDesc, "rows='3' class='form-control' readOnly='true'");?></td><td></td>
      </tr> 
    </table>
    ...
    <table class='table table-form'> 
 	 <tr>
        ...
        <td>
          <div class='input-group'>
            <?php echo html::input('date',$date, "class=' w-140px form-date h-30px'  onchange='computeWorkDays()' placeholder='" . $lang->sprint->conferenceTime . "'");?>
          	&nbsp; &nbsp;
