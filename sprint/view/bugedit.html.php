      ...
      <fieldset>
        ...
        <table class='table table-form'>
          ...
          <tr>
            ...
            <td><?php
               echo html::select('plan', $plans, $planID, "onchange=loadAll(this.value) class='form-control ' autocomplete='off' style='display:none'");
               echo current($plans);
            ?></td>
          </tr>
          <tr>
            <th><?php echo $lang->bug->project;?></th>
             <td><span id='projectIdBox'>
              <?php echo html::select('project', $projects, $projectID, "class='form-control ' onchange='loadProjectRelated(this.value)' autocomplete='off' style='display:none'");
