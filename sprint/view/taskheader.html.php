<!-- remove style by xufangye -->
<div id='featurebar'> 
  <ul class='nav'>
  <?php
    echo "<li id='unclosedTab'>"; common::printLink('sprint', 'task', "project=$projectID&type=unclosed", $lang->project->unclosed); echo '</li>' ;
    echo "<li id='allTab'>"; common::printLink('sprint', 'task', "project=$projectID&type=all", $lang->project->allTasks); echo '</li>' ;
    ...
    echo "<li id='assignedtomeTab'>"; common::printLink('sprint', 'task', "project=$projectID&type=assignedtome", $lang->project->assignedToMe); echo  '</li>' ;
    ...
    foreach ($lang->project->statusSelects as $key => $value)
    {
        ...
        echo html::a($this->createLink('sprint', 'task', "project=$projectID&type=$key"), $value);
    }
    echo '</ul></li>';
  ...
  <div class='actions'>
    <div class='btn-group'>
      ...
      common::printIcon('task', 'report', "project=$projectID");
      ?>
      ...
      <div class='btn-group'>
        ...
        <?php common::printIcon('task', 'export', "project=$projectID&orderBy=$orderBy", '', 'button', '', '', 'export');?>
    ...
    <div class='btn-group'>
    <?php
    common::printIcon('sprint', 'taskbatchCreate', "projectID=$projectID");
