...
$lang->action->desc->reopened       = '$date, 由 <strong>$actor</strong> 重新打开。' . "\n";
...
$lang->action->desc->recordestimate = '$date, 由 <strong>$actor</strong> 记录点数，消耗 <strong>$extra</strong> 点数。';
$lang->action->desc->editestimate   = '$date, 由 <strong>$actor</strong> 编辑点数。';
$lang->action->desc->deleteestimate = '$date, 由 <strong>$actor</strong> 删除点数。';
...
$lang->action->label->recordestimate      = '记录了点数';
$lang->action->label->editestimate        = '编辑了点数';
...
$lang->action->label->deleteestimate      = "删除了点数";
