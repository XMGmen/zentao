...
<div id="procreatesprint">
	<ul id="myTab" class="nav nav-tabs">
		<li id='indexid' class="active">
        <?php echo html::a($this->createLink('company', 'index'),"用户");?>
        </li>
		<li id='backlogid'>
        <?php //echo html::a($this->createLink('dept', 'browse', "deptID=$deptID"),"部门");?>
        <?php 
		...
		<li id='bugid'>
        <?php //echo html::a($this->createLink('group', 'browse', "companyID=$companyID"),"权限");?>
...
<div id='querybox' class='show' style='width: 100%'><?php echo $searchForm?></div>
<div class='side' id='companystruct'>
  <div class='side-body'>
...
<div id="tablestyle" class="companytablestyle">
<div class='main'>
